...
(function($) {
    ...
    var eCalendar = function(options, object) {
        ...
        function print() {
            ...
            var cAdd = $('<div/>').addClass('c-addicon c-grid-title c-pad-top');
            var cIcon = $('<div/>').addClass('c-icon c-grid-title c-pad-top');
            cPrevious.html(settings.textArrows.previous);
            cMonth.html(settings.months[dMonth]);
            cNext.html(settings.textArrows.next);
            cAdd.html(settings.textArrows.next);
            cIcon.html(settings.textArrows.next);
